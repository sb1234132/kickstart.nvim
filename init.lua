...
-- Terminal split keybindings: These provide quick access to terminal windows in different layouts.
-- The backslash prefix allows for convenient chord bindings without conflicting with normal vim motions.
...
require('lazy').setup({
  ...
  -- Colorscheme plugin (currently disabled)
